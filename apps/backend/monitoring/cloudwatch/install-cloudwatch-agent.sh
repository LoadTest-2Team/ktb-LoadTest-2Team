...
LOG_GROUP_PREFIX="/ktb/prod"
BACKEND_HOME="/home/ubuntu/ktb-chat-backend"
...
configure_credentials() {
  ...
  elif [[ ! -s "$AGENT_ETC/common-config.toml" ]]; then
    echo "No credentials file supplied; using the EC2 instance profile."
  fi
}
